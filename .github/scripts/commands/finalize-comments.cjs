...
//
// commands/finalize-comments.cjs
//
...
const SKILL_BOILERPLATE = {
  [LABELS.GOOD_FIRST_ISSUE]: {
    ...
    introContent: [
      'This issue is especially welcoming for people who are new to contributing to the **KDM CLI**.',
      '',
      ...
      '',
      'No prior knowledge of KDM, Hedera, or distributed ledger technology is required - just a basic familiarity with C++ and Git is more than enough to get started.',
    ].join('\n'),
    importantBlock: [
      '> [!IMPORTANT]',
  ...
  [LABELS.BEGINNER]: {
    ...
    introContent: [
      'This issue is a great fit for contributors who are ready to explore the KDM C++ codebase a little more and take on slightly more independent work.',
      '',
  ...
  [LABELS.INTERMEDIATE]: {
    ...
    introContent: [
      'This issue is a good fit for contributors who are already familiar with the KDM CLI and feel comfortable navigating the codebase.',
      '',
  ...
  [LABELS.ADVANCED]: {
    introLabel: '🧠 Advanced',
    introContent: [
      'This issue is well-suited for contributors who are very familiar with the KDM CLI and enjoy working with its core abstractions and design patterns.',
      '',
...
const DEFAULT_ADDITIONAL_INFO_CONTENT = [
  ...
  '',
  `You can reach the community and maintainers here: [KDM-CLI Discord](${COMMUNITY.discordChannel})`,
  '',
