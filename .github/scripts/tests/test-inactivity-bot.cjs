...
//
// tests/test-inactivity-bot.cjs
//
// Integration tests for bot-inactivity.cjs.
// Run with: node .github/scripts/tests/test-inactivity-bot.cjs

const { runTestSuite } = require('./test-utils');
const script = require('../bot-inactivity.cjs');
...
/**
 * Creates a mock GitHub API for bot-inactivity.cjs tests.
 *
 * @param {object} opts
