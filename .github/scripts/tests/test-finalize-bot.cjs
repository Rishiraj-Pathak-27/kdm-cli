...
//
// tests/test-finalize-bot.cjs
//
// Local test script for the /finalize command (bot-on-comment.cjs → commands/finalize.cjs).
// Run with: node .github/scripts/tests/test-finalize-bot.cjs
//
...
@utkarsh232005 — could you please verify @maintainer's permissions and complete the finalization manually if appropriate?

Sorry for the inconvenience!`;

const COMMENT_UPDATE_FAILURE = `⚠️ Hi @maintainer! I encountered an error while trying to update the issue title or body.

@utkarsh232005 — could you please complete the finalization manually?
...
// =============================================================================
// UNIT TESTS — pure functions from finalize-comments.cjs
// =============================================================================
