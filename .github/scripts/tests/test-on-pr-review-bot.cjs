...
//
// tests/test-on-pr-review-bot.cjs
//
// Integration tests for bot-on-pr-review.cjs (pull_request_review trigger).
// Run with: node .github/scripts/tests/test-on-pr-review-bot.cjs

const { runTestSuite, createMockGithub } = require('./test-utils');
const script = require('../bot-on-pr-review.cjs');
