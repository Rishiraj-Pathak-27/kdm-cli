...
//
// tests/test-comments.cjs
//
// Unit tests for helpers/comments.cjs (unified bot comment builder).
// Run with: node .github/scripts/tests/test-comments.cjs
