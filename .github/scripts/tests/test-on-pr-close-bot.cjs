...
//
// tests/test-on-pr-close-bot.cjs
//
// Integration tests for bot-on-pr-close.cjs post-merge automation.
// Run with: node .github/scripts/tests/test-on-pr-close-bot.cjs

const { runTestSuite } = require('./test-utils');
const script = require('../bot-on-pr-close.cjs');
