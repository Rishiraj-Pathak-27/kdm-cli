...
//
// tests/test-unassign-bot.cjs
//
// Local test script for the /unassign command in bot-on-comment.cjs.
// Run with: node .github/scripts/tests/test-unassign-bot.cjs
//
