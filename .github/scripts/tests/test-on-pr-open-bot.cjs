...
//
// tests/test-on-pr-open-bot.cjs
//
// Integration tests for bot-on-pr-open.cjs (opened/reopened/ready_for_review).
// Run with: node .github/scripts/tests/test-on-pr-open-bot.cjs
...
const script = require('../bot-on-pr-open.cjs');
