...
//
// tests/test-assign-bot.cjs
//
// Local test script for bot-on-comment.cjs
// Run with: node .github/scripts/tests/test-assign-bot.cjs
//
...
const script = require("../bot-on-comment.cjs");
...
const scenarios = [
  {
    ...
    context: {
      ...
      repo: { owner: "kdm-ledger", repo: "kdm-cli" },
    },
...

  {
    ...
    expectedComments: [
      `👋 Hi @new-contributor, welcome to the KDM CLI community! Thank you for choosing to contribute — we're thrilled to have you here! 🎉
...
Good luck, and welcome aboard! 🚀`,
...

  {
    ...
    expectedComments: [
      `👋 Hi @experienced-contributor, thanks for continuing to contribute to the KDM CLI! You've been assigned this **Beginner** issue. 🙌
...
Good luck! 🚀`,
...

  {
    ...
    expectedComments: [
      `👋 Hi @growing-contributor, thanks for continuing to contribute to the KDM CLI! You've been assigned this **Intermediate** issue. 🙌
...
Good luck! 🚀`,
...

  {
    ...
    expectedComments: [
      `👋 Hi @senior-contributor, thanks for continuing to contribute to the KDM CLI! You've been assigned this **Advanced** issue. 🙌
...
Good luck! 🚀`,
...

  {
    ...
    expectedComments: [
      `👋 Hi @bypass-user-1, thanks for continuing to contribute to the KDM CLI! You've been assigned this **Beginner** issue. 🙌\n\nIf this task involves any design decisions or you'd like early feedback, feel free to share your plan here before diving into the code.\n\nIf you realize you cannot complete this issue, simply comment \`/unassign\` to return it to the pool.\n\nGood luck! 🚀`,
    ],
  },

  {
    ...
    expectedComments: [
      `👋 Hi @bypass-user-2, thanks for continuing to contribute to the KDM CLI! You've been assigned this **Beginner** issue. 🙌\n\nIf this task involves any design decisions or you'd like early feedback, feel free to share your plan here before diving into the code.\n\nIf you realize you cannot complete this issue, simply comment \`/unassign\` to return it to the pool.\n\nGood luck! 🚀`,
    ],
  },
...
[Browse available Beginner issues](https://github.com/KDM-cli/kdm-cli/issues?q=is%3Aissue%20is%3Aopen%20no%3Aassignee%20label%3A%22skill%3A%20beginner%22%20label%3A%22status%3A%20ready%20for%20dev%22)
...
Come take on something more challenging — we're excited to see what you'll build next! 🚀`,
...

  {
    ...
    expectedComments: [
      `👋 Hi @almost-capped-user, welcome to the KDM CLI community! Thank you for choosing to contribute — we're thrilled to have you here! 🎉
...
Good luck, and welcome aboard! 🚀`,
...

  {
    ...
    expectedComments: [
      `👋 Hi @gfi-graduated-user, thanks for continuing to contribute to the KDM CLI! You've been assigned this **Beginner** issue. 🙌
...
[Browse available Good First Issues](https://github.com/KDM-cli/kdm-cli/issues?q=is%3Aissue%20is%3Aopen%20no%3Aassignee%20label%3A%22skill%3A%20good%20first%20issue%22%20label%3A%22status%3A%20ready%20for%20dev%22)
...
[Your open assignments](https://github.com/KDM-cli/kdm-cli/issues?q=is%3Aissue%20is%3Aopen%20assignee%3Abusy-contributor%20-label%3A%22status%3A%20blocked%22)
...
👉 **View your assigned issues:**
[Your open assignments](https://github.com/KDM-cli/kdm-cli/issues?q=is%3Aissue%20is%3Aopen%20assignee%3Avery-busy-contributor%20-label%3A%22status%3A%20blocked%22)
...
👉 **View your assigned issues:**
[Your open assignments](https://github.com/KDM-cli/kdm-cli/issues?q=is%3Aissue%20is%3Aopen%20assignee%3Anow-over-limit-user%20-label%3A%22status%3A%20blocked%22)
...
👉 **View your assigned issues:**
[Your open assignments](https://github.com/KDM-cli/kdm-cli/issues?q=is%3Aissue%20is%3Aopen%20assignee%3Aat-limit-with-blocked%20-label%3A%22status%3A%20blocked%22)

👉 **View your blocked issues:**
[Your blocked issues](https://github.com/KDM-cli/kdm-cli/issues?q=is%3Aissue%20is%3Aopen%20assignee%3Aat-limit-with-blocked%20label%3A%22status%3A%20blocked%22)
...
Once you complete or unassign from one of your current issues, come back and we'll be happy to assign this to you! 🎯`,
...

  {
    ...
    expectedComments: [
      `👋 Hi @active-contributor, welcome to the KDM CLI community! Thank you for choosing to contribute — we're thrilled to have you here! 🎉
...
Good luck, and welcome aboard! 🚀`,
...

  {
    ...
    expectedComments: [
      `👋 Hi @blocked-contributor, welcome to the KDM CLI community! Thank you for choosing to contribute — we're thrilled to have you here! 🎉
...
@utkarsh232005 — could you please manually assign @unlucky-user-2 to this issue?
...
Error details: Simulated assignment failure`,
...

  {
    ...
    expectedComments: [
      `👋 Hi @partially-lucky, welcome to the KDM CLI community! Thank you for choosing to contribute — we're thrilled to have you here! 🎉
...
Error details: Failed to remove 'status: ready for dev': Simulated remove label failure; Failed to add 'status: in progress': Simulated add label failure`,
...

  {
    ...
    expectedComments: [
      `👋 Hi @bypass-review-user-1, welcome to the KDM CLI community! Thank you for choosing to contribute — we're thrilled to have you here! 🎉\n\nYou've been assigned this **Good First Issue**, and the **Good First Issue Support Team** (@utkarsh232005) is ready to help you succeed.\n\nThe issue description above has everything you need: implementation steps, contribution workflow, and links to guides. If anything is unclear, just ask — we're happy to help.\n\nIf you realize you cannot complete this issue, simply comment \`/unassign\` to return it to the community pool.\n\nGood luck, and welcome aboard! 🚀`,
    ],
  },
...

  {
    ...
    expectedComments: [
      `👋 Hi @bypass-review-user-5, welcome to the KDM CLI community! Thank you for choosing to contribute — we're thrilled to have you here! 🎉\n\nYou've been assigned this **Good First Issue**, and the **Good First Issue Support Team** (@utkarsh232005) is ready to help you succeed.\n\nThe issue description above has everything you need: implementation steps, contribution workflow, and links to guides. If anything is unclear, just ask — we're happy to help.\n\nIf you realize you cannot complete this issue, simply comment \`/unassign\` to return it to the community pool.\n\nGood luck, and welcome aboard! 🚀`,
    ],
  },
