...
//
// tests/test-on-pr-update-bot.cjs
//
// Integration tests for bot-on-pr-update.cjs (synchronize + edited triggers).
// Run with: node .github/scripts/tests/test-on-pr-update-bot.cjs
...
const script = require('../bot-on-pr-update.cjs');
